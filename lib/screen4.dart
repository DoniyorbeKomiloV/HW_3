...
class Fanta extends StatefulWidget {
  ...
  @override
  State<Fanta> createState() => Screen3State();
}

class Screen3State extends State<Fanta> {
  int _counter15 = 0;
  int _counter10 = 0;
  int _counter05 = 0;
  int _counter025 = 0;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const Text("Fanta", style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
          ...
          Column(
            children: [
              Row(
                ...
                children: [
                  const Text("Fanta 1.5l", style: TextStyle(fontWeight: FontWeight.bold)),
                  Row(
                    children: [
                      ElevatedButton(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  const Text("Fanta 1.0l", style: TextStyle(fontWeight: FontWeight.bold)),
                  Row(
                    children: [
                      ElevatedButton(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  const Text("Fanta 0.5l", style: TextStyle(fontWeight: FontWeight.bold)),
                  Row(
                    children: [
                      ElevatedButton(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  const Text("Fanta 0.25l", style: TextStyle(fontWeight: FontWeight.bold)),
                  Row(
                    children: [
                      ElevatedButton(
    ...
    return _counter025!=0 ? Column(
      children: [
        Row(
          ...
          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children: [
            Text("Fanta 0.5 l x $_counter025 "),
  ...
  String getString() {
    ...
    if(_counter15!=0 && (_counter025+_counter05+_counter10)!=0){
      response += "Fanta 1.5 l x $_counter15!12000 x $_counter15 = ${12000*_counter15}:";
    } else if (_counter15!=0){
      response += "Fanta 1.5 l x $_counter15!12000 x $_counter15 = ${12000*_counter15}";
      return response;
    }
    if(_counter10!=0  && (_counter025+_counter05)!=0){
      response += "Fanta 1.0 l x $_counter10!10000 x $_counter10 = ${10000*_counter10}:";
    } else if(_counter10!=0){
      response += "Fanta 1.0 l x $_counter10!10000 x $_counter10 = ${10000*_counter10}";
      return response;
    }
    if(_counter05!=0 && _counter025!=0){
      response += "Fanta 0.5 l x $_counter05!6000 x $_counter05 = ${6000*_counter05}:";
    } else if(_counter05!=0){
      response += "Fanta 0.5 l x $_counter05!6000 x $_counter05 = ${6000*_counter05}";
      return response;
    }
    if(_counter025!=0){
      response += "Fanta 0.25 l x $_counter025!4000 x $_counter025 = ${4000*_counter025}";
    }
    return response;
  }
